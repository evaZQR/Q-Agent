...
class DefaultResultsStorage:
    def __init__(self, openai_key = OPENAI_API_KEY, result_store_name = RESULTS_STORE_NAME):
    ...
    def add(self, task: Dict, result: str, result_id: str, is_human: bool = False):
...
def use_chroma():
    ...
    return DefaultResultsStorage(OPENAI_API_KEY, RESULTS_STORE_NAME)